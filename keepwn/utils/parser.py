...
def parse_args():
    ...
    subparsers = main_parser.add_subparsers(help="TODO", dest="mode")
    search_subparser = subparsers.add_parser("search", parents=[search_parser])
    trigger_subparser = subparsers.add_parser("trigger", parents=[trigger_parser])
    trigger_subparsers = trigger_subparser.add_subparsers(help="TODO", dest="trigger_mode")
    ...
    plugin_subparser = subparsers.add_parser("plugin", parents=[plugin_parser])
    plugin_subparsers = plugin_subparser.add_subparsers(help="TODO", dest="plugin_mode")
